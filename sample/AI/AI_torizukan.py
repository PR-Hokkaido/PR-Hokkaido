...
def read_train_data(ho=0, kind='train'):
    ...
    #  学習用データ読み込み
    for j in range(0, 4): #****ここを埋めてください③**** # クラス数と同じ回数、繰り返す
    ...
    train_target = np_utils.to_categorical(train_target, 4) #****ここを埋めてください③****
...
def vgg16_model():
    ...
    #  入力の形を定義する
    input_tensor = Input(shape=(100, 100, 3)) #****ここを埋めてください②****
